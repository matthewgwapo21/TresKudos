...
Route::middleware(['auth', 'admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::put('/users/{user}/promote', [\App\Http\Controllers\Admin\AdminUserController::class, 'promote'])->name('admin.users.promote');
    Route::put('/users/{user}/demote', [\App\Http\Controllers\Admin\AdminUserController::class, 'demote'])->name('admin.users.demote');
